...
describe('First test', function(){
    ...
    it('Login and check username',function(){
        ...
        cy.get(POM.homepage.searchinput).type(Amazondata.inputdata.itemname)
        cy.get(POM.homepage.searchicon).click()
        cy.get('.s-main-slot.s-result-list.s-search-results.sg-row > div:nth-child(1) h2 > a').invoke('removeAttr', 'target').click()
        //cy.get('div.s-main-slot.s-result-list.s-search-results.sg-row > div:nth-child(1) h2').click()
